  ...
  return (
    ...
    >
      <div className={styles.PolicyModal__content}>
        ...
        веб-сайта <a href="httpsː//thismywebsite.com">httpsː//thismywebsite·com</a>.
        <br />
        ...
        <a href="httpsː//thismywebsite.com">httpsː//thismywebsite·com</a>;<br /> 2.4. Информационная
        система персональных данных — совокупность содержащихся в базах данных персональных данных,
        ...
        <a href="httpsː//thismywebsite.com">httpsː//thismywebsite·com</a>;<br /> 2.9. Пользователь –
        любой посетитель веб-сайта <a href="httpsː//thismywebsite.com">httpsː//thismywebsite·com</a>
        ;<br />
        ...
        и/или материалам, содержащимся на веб-сайте httpsː//thismywebsite·com; уточнение деталей
        заказа.
        <br />
        4.2. <br />
        ...
        <br />
        5.1. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения
        и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте{' '}
        <a href="httpsː//thismywebsite.com">httpsː//thismywebsite·com</a>. Заполняя соответствующие
        ...
        privacy@thismywebsite·com с пометкой «Отзыв согласия на обработку персональных данных».{' '}
        <br />
        ...
        <a href="mailto:privacy@thismywebsite.com">privacy@thismywebsite·com</a>.
        <br />
        ...
        <a href="httpsː//thismywebsite.com/privacy/">httpsː//thismywebsite·com/privacy/</a>.
      </div>
    </Modal>
  );
};
